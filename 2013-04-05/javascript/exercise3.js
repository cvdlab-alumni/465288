...
//Struttura dei piani
var floors = STRUCT([floor_1,floor_2,floor3,ground_floor,floor4]);
...
var west = STRUCT([west_1,west_21,west_22,west_3,west_41,west_42,west_43,west_5]);
...
var est = STRUCT([est_1,est_21,est_22,est_3,est_41,est_42,est_5,est_6,est_7,est_8]);
est = T([2])([-0.13])(est);
...
var east = STRUCT([est,east_groundfloor]);
...
var north = STRUCT([nord, north_groundfloor]);
...
var south = STRUCT([sud, south_groundfloor]);


//Struttura dei muri esterni
var building = STRUCT([pillars0, pillars1, pillars2, pillars3, floors, prato,west,east,north,south]);
VIEW(building);  
